...
Proyecto: cuenta-atras-a-eventos
Ruta: `projects/cuenta-atras-a-eventos`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `cuenta-atras-a-eventos` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| eventCountdown | EventCountdownWebPart | 3750263f-3257-421d-96b1-d1fe505edcd8 |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-042 | EventCountdownWebPart | Reutilizable | Media |
