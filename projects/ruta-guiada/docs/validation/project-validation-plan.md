...
Proyecto: ruta-guiada
Ruta: `projects/ruta-guiada`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `ruta-guiada` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| guidedRoute | GuidedRouteWebPart | a534acae-ef0b-481e-8c1b-309310f9d930 |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-033 | GuidedRouteWebPart | Experimental | Media |
