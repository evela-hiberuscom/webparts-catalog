...
Proyecto: estado-de-servicios-internos
Ruta: `projects/estado-de-servicios-internos`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `estado-de-servicios-internos` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| internalServicesStatus | InternalServicesStatusWebPart | 7bd2d279-b8da-4292-adbd-be99d160ff8c |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-021 | InternalServicesStatusWebPart | Reutilizable | Alta |
