...
Proyecto: faq-inteligente
Ruta: `projects/faq-inteligente`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `faq-inteligente` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| smartFaq | SmartFaqWebPart | 2903ac67-80cb-4270-aa01-756e0e884612 |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-037 | SmartFaqWebPart | Maduro | Alta |
