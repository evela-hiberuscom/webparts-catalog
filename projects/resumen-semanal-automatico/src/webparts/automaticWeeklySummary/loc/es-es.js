define([], function() {
  return {
    "PropertyPaneDescription": "Configura el resumen semanal automático y el período de tiempo.",
    "BasicGroupName": "Ajustes del resumen",
    "TitleFieldLabel": "Título",
    "SubtitleFieldLabel": "Subtítulo",
    "PeriodModeFieldLabel": "Modo de período",
    "CurrentWeekLabel": "Semana actual",
    "PreviousWeekLabel": "Semana anterior",
    "CustomRangeLabel": "Rango personalizado",
    "MaxItemsFieldLabel": "Máximo de elementos",
    "CustomRangeStartFieldLabel": "Inicio del rango personalizado (AAAA-MM-DD)",
    "CustomRangeEndFieldLabel": "Fin del rango personalizado (AAAA-MM-DD)",
    "CustomRangeHelpText": "Usa fechas ISO. Si se deja en blanco, el resumen usa la semana actual.",
