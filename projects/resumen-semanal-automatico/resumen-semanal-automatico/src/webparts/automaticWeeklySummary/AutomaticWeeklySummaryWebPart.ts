...
import { IAutomaticWeeklySummaryProps } from './components/IAutomaticWeeklySummaryProps';
...
export default class AutomaticWeeklySummaryWebPart extends BaseClientSideWebPart<IAutomaticWeeklySummaryWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IAutomaticWeeklySummaryProps> = React.createElement(
