...
Proyecto: tarjeta-de-decision-rapida
Ruta: `projects/tarjeta-de-decision-rapida`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `tarjeta-de-decision-rapida` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| quickDecisionCard | QuickDecisionCardWebPart | 5a26ba71-de13-406f-a97a-9b3756bc5bbe |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-052 | QuickDecisionCardWebPart | Incompleto | Baja |
