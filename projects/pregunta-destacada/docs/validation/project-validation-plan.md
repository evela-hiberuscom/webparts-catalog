...
Proyecto: pregunta-destacada
Ruta: `projects/pregunta-destacada`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `pregunta-destacada` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| featuredQuestion | FeaturedQuestionWebPart | 43970daf-806c-48b5-b772-ec5da867fd6f |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-040 | FeaturedQuestionWebPart | Experimental | Baja |
