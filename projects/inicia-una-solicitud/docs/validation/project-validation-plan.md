...
Proyecto: inicia-una-solicitud
Ruta: `projects/inicia-una-solicitud`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `inicia-una-solicitud` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| startARequest | StartARequestWebPart | 38f407f8-3dea-478a-bbe8-d76a9db1fd2d |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-032 | StartARequestWebPart | Maduro | Media |
