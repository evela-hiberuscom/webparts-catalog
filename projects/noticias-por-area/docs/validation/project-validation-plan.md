...
Proyecto: noticias-por-area
Ruta: `projects/noticias-por-area`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `noticias-por-area` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| newsByArea | NewsByAreaWebPart | 41d8c2ba-2491-4ad0-b7aa-df3bdb195629 |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-013 | NewsByAreaWebPart | Maduro | Media |
