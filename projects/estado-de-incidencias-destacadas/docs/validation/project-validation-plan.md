...
Proyecto: estado-de-incidencias-destacadas
Ruta: `projects/estado-de-incidencias-destacadas`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `estado-de-incidencias-destacadas` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| highlightedIncidents | HighlightedIncidentsWebPart | 47e6780b-fe19-41b7-ac02-945a2b93efa5 |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-022 | HighlightedIncidentsWebPart | Reutilizable | Alta |
