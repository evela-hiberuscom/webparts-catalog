define([], function() {
  return {
    "PropertyPaneDescription": "Configura el origen de datos y el comportamiento de la checklist de onboarding.",
    "BasicGroupName": "Checklist",
    "TitleFieldLabel": "Título",
    "DescriptionFieldLabel": "Descripción",
    "DataSourceTypeFieldLabel": "Origen de datos",
    "WebUrlFieldLabel": "URL del sitio",
    "ListTitleOrUrlFieldLabel": "Título o URL de lista",
    "JsonUrlFieldLabel": "URL JSON",
    "StaticConfigJsonFieldLabel": "Configuración local JSON",
    "DefaultVariantFieldLabel": "Variante por defecto",
    "DefaultPhaseFieldLabel": "Fase por defecto",
