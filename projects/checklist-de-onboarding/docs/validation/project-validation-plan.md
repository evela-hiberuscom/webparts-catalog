...
Proyecto: checklist-de-onboarding
Ruta: `projects/checklist-de-onboarding`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `checklist-de-onboarding` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| onboardingChecklist | OnboardingChecklistWebPart | c7a3babf-e1d7-42b2-9051-bc73a6c0b9d9 |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-030 | OnboardingChecklistWebPart | Maduro | Alta |
