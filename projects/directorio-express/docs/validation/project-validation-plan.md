...
Proyecto: directorio-express
Ruta: `projects/directorio-express`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `directorio-express` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| expressDirectory | ExpressDirectoryWebPart | ea5b1fd7-c38c-4191-bf68-f93c2e6d167c |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-026 | ExpressDirectoryWebPart | Maduro | Alta |
