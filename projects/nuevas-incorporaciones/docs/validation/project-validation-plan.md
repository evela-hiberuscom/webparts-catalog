...
Proyecto: nuevas-incorporaciones
Ruta: `projects/nuevas-incorporaciones`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `nuevas-incorporaciones` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| newJoiners | NewJoinersWebPart | f903bb5e-62a6-43f1-b70e-5aa5ff021cf7 |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-006 | NewJoinersWebPart | Maduro | Alta |
