define([], function() {
  return {
    "PropertyPaneDescription": "Configure the new joiners to show",
    "WebPartTitle": "New joiners",
    ...
    "MaxItemsFieldLabel": "Maximum number of joiners",
    "DaysBackFieldLabel": "Days back",
