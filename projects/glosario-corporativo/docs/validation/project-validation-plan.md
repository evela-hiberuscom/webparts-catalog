...
Proyecto: glosario-corporativo
Ruta: `projects/glosario-corporativo`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `glosario-corporativo` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| corporateGlossary | CorporateGlossaryWebPart | f9dbe3c9-12cf-4228-ac21-46a7bbea561f |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-039 | CorporateGlossaryWebPart | Maduro | Alta |
