...
import { IUniversalAppLauncherProps } from './components/IUniversalAppLauncherProps';
...
export default class UniversalAppLauncherWebPart extends BaseClientSideWebPart<IUniversalAppLauncherWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IUniversalAppLauncherProps> = React.createElement(
