...
Proyecto: reserva-rapida
Ruta: `projects/reserva-rapida`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `reserva-rapida` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| quickBooking | QuickBookingWebPart | cd63f130-9467-4771-8fbf-aab228cf6467 |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-049 | QuickBookingWebPart | Maduro | Baja |
