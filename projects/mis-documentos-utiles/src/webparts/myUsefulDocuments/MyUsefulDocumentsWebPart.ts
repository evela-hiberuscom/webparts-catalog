...
import MyUsefulDocuments from './components/MyUsefulDocuments';
...
export interface IMyUsefulDocumentsWebPartProps extends IUsefulDocumentsConfiguration {}

export default class MyUsefulDocumentsWebPart extends BaseClientSideWebPart<IMyUsefulDocumentsWebPartProps> {
  private _service: UsefulDocumentsService | undefined;
  ...
  public render(): void {
    ...
    this._service = new UsefulDocumentsService(repository);

    const element: React.ReactElement = React.createElement(MyUsefulDocuments, {
      configuration: {
