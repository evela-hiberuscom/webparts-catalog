...
Proyecto: mis-tareas-y-pendientes
Ruta: `projects/mis-tareas-y-pendientes`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `mis-tareas-y-pendientes` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| myTasksAndPending | MyTasksAndPendingWebPart | dc981023-ae3b-4c51-9eb8-6e266b97bc97 |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-017 | MyTasksAndPendingWebPart | Maduro | Alta |
