...
Proyecto: mantenimientos-programados
Ruta: `projects/mantenimientos-programados`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `mantenimientos-programados` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| plannedMaintenance | PlannedMaintenanceWebPart | 90172b97-6a14-4031-b468-5ccb18a920ee |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-048 | PlannedMaintenanceWebPart | Incompleto | Baja |
