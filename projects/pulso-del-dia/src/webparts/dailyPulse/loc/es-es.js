define([], function() {
  return {
    "PropertyPaneDescription": "Configuración del pulso diario",
    "BasicGroupName": "Origen y pregunta",
    "TitleFieldLabel": "Título",
    "SubtitleFieldLabel": "Subtítulo",
    "SourceTypeFieldLabel": "Tipo de origen",
    "WebUrlFieldLabel": "URL del sitio web",
    "ListTitleOrUrlFieldLabel": "Título o URL de la lista",
    "JsonUrlFieldLabel": "URL JSON",
    "ApiEndpointFieldLabel": "URL del endpoint API",
    "PromptJsonFieldLabel": "JSON de pregunta",
    "OneResponsePerDayFieldLabel": "Una respuesta por día",
    "SubmitLabelFieldLabel": "Texto del botón de envío",
