...
Proyecto: buscador-de-recursos-corporativos
Ruta: `projects/buscador-de-recursos-corporativos`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `buscador-de-recursos-corporativos` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| corporateResourcesSearch | CorporateResourcesSearchWebPart | 58b6d438-cf81-4503-9df7-50da126ddde0 |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-027 | CorporateResourcesSearchWebPart | Maduro | Alta |
