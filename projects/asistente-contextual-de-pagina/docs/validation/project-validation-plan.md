...
Proyecto: asistente-contextual-de-pagina
Ruta: `projects/asistente-contextual-de-pagina`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `asistente-contextual-de-pagina` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| pageContextAssistant | PageContextAssistantWebPart | ea02998e-4c3a-4a61-87af-d0b3c9f36701 |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-050 | PageContextAssistantWebPart | Reutilizable | Alta |
