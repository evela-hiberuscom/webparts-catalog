...
import * as strings from 'SecurityComplianceReviewWebPartStrings';
import { SecurityComplianceReviewDashboard } from './components/SecurityComplianceReviewDashboard';
...
export interface ISecurityComplianceReviewWebPartProps {
  title: string;
  subtitle: string;
  maxItems: number;
  showDetails: boolean;
...
export default class SecurityComplianceReviewWebPart extends BaseClientSideWebPart<ISecurityComplianceReviewWebPartProps> {
  ...
  public render(): void {
    ...
    const element = React.createElement(SecurityComplianceReviewDashboard, {
