...
export const mockGovernanceDashboardData: IGovernanceDashboardData = {
  initiativeId: 'GOV-23',
  initiativeTitle: "Establecer revisiones periódicas de seguridad y cumplimiento",
  phase: "Fase 2",
  initiativeType: "Governance review calendar",
  sourceLabel: 'Mock data aligned with Governance Pack GOV-23',
  ...
  findings: [
    {
      id: 'GOV-23-F01',
      title: "Establecer revisiones periódicas de seguridad y cumplimiento - evidencia parcial",
      severity: 'medium',
      confidence: 'medium',
      status: 'pending',
    ...
    {
      id: 'GOV-23-F02',
      title: "Establecer revisiones periódicas de seguridad y cumplimiento - campaña de revisión",
      severity: 'medium',
      confidence: 'high',
      status: 'inReview',
      owner: 'Site Owner',
    ...
    {
      id: 'GOV-23-F03',
      title: "Establecer revisiones periódicas de seguridad y cumplimiento - integración pendiente",
      severity: 'medium',
      confidence: 'low',
      status: 'exception',
