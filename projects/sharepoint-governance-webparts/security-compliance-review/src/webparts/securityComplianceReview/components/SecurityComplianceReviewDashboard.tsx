...
export interface ISecurityComplianceReviewDashboardProps extends IGovernanceDashboardConfig {
...
export function SecurityComplianceReviewDashboard(props: ISecurityComplianceReviewDashboardProps): React.ReactElement {
