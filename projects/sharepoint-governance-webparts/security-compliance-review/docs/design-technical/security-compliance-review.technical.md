# security-compliance-review — Technical design

## Components

- `SecurityComplianceReviewWebPart.ts`: SPFx entry point, property pane and ErrorBoundary wiring.
- `SecurityComplianceReviewDashboard.tsx`: visual composition.
...
**Crítica adversarial:** Revisiones demasiado frecuentes generan ruido. El calendario debe ser risk-based, no igual para todo.
