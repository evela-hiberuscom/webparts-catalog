...
export const mockGovernanceDashboardData: IGovernanceDashboardData = {
  initiativeId: 'GOV-18',
  initiativeTitle: "Revisar contenido obsoleto en páginas, noticias y documentos",
  phase: "Fase 4",
  initiativeType: "Content freshness governance",
  sourceLabel: 'Mock data aligned with Governance Pack GOV-18',
  ...
  findings: [
    {
      id: 'GOV-18-F01',
      title: "Revisar contenido obsoleto en páginas, noticias y documentos - evidencia parcial",
      severity: 'high',
      confidence: 'medium',
      status: 'pending',
    ...
    {
      id: 'GOV-18-F02',
      title: "Revisar contenido obsoleto en páginas, noticias y documentos - campaña de revisión",
      severity: 'high',
      confidence: 'high',
      status: 'inReview',
      owner: 'Site Owner',
    ...
    {
      id: 'GOV-18-F03',
      title: "Revisar contenido obsoleto en páginas, noticias y documentos - integración pendiente",
      severity: 'medium',
      confidence: 'low',
      status: 'exception',
