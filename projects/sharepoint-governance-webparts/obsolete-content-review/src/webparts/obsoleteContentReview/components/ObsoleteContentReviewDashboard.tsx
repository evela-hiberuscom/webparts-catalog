...
export interface IObsoleteContentReviewDashboardProps extends IGovernanceDashboardConfig {
...
export function ObsoleteContentReviewDashboard(props: IObsoleteContentReviewDashboardProps): React.ReactElement {
