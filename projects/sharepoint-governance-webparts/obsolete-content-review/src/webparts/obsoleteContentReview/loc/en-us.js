define([], function() {
  return {
    "PropertyPaneDescription": "Obsolete Content Review settings",
    ...
    "WebPartTitle": "Obsolete Content Review",
    "WebPartDescription": "Review of obsolete pages, news and documents.",
