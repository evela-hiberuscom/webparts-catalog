...
import * as strings from 'ObsoleteContentReviewWebPartStrings';
import { ObsoleteContentReviewDashboard } from './components/ObsoleteContentReviewDashboard';
...
export interface IObsoleteContentReviewWebPartProps {
  title: string;
  subtitle: string;
  maxItems: number;
  showDetails: boolean;
...
export default class ObsoleteContentReviewWebPart extends BaseClientSideWebPart<IObsoleteContentReviewWebPartProps> {
  ...
  public render(): void {
    ...
    const element = React.createElement(ObsoleteContentReviewDashboard, {
