# obsolete-content-review — Technical design

## Components

- `ObsoleteContentReviewWebPart.ts`: SPFx entry point, property pane and ErrorBoundary wiring.
- `ObsoleteContentReviewDashboard.tsx`: visual composition.
...
**Crítica adversarial:** Fecha de modificación no equivale a vigencia. Un documento antiguo puede seguir siendo válido. Necesita metadatos de revisión y validación humana.
