...
Proyecto: sensitivity-labels-governance
Ruta: `projects/sharepoint-governance-webparts/sensitivity-labels-governance`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `sensitivity-labels-governance` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| sensitivityLabelsGovernance | SensitivityLabelsGovernanceWebPart | d923315c-2806-4669-a8e7-fc60cf5008a4 |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-061 | SensitivityLabelsGovernanceWebPart | Mock-backed auditado | Media |
