# sensitivity-labels-governance — Technical design

## Components

- `SensitivityLabelsGovernanceWebPart.ts`: SPFx entry point, property pane and ErrorBoundary wiring.
- `SensitivityLabelsGovernanceDashboard.tsx`: visual composition.
...
**Crítica adversarial:** Aplicar etiquetas puede cambiar sharing, privacidad o acceso. No debe automatizarse sin modelo de clasificación, pruebas piloto y aceptación de negocio.
