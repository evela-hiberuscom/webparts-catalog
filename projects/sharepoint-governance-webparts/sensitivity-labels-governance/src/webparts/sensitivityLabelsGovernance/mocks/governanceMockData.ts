...
export const mockGovernanceDashboardData: IGovernanceDashboardData = {
  initiativeId: 'GOV-09',
  initiativeTitle: "Aplicar etiquetas de sensibilidad a sitios, grupos, Teams o documentos",
  phase: "Fase 5",
  initiativeType: "Integración Purview + recomendación",
  sourceLabel: 'Mock data aligned with Governance Pack GOV-09',
  ...
  findings: [
    {
      id: 'GOV-09-F01',
      title: "Aplicar etiquetas de sensibilidad a sitios, grupos, Teams o documentos - evidencia parcial",
      severity: 'high',
      confidence: 'medium',
      status: 'pending',
    ...
    {
      id: 'GOV-09-F02',
      title: "Aplicar etiquetas de sensibilidad a sitios, grupos, Teams o documentos - campaña de revisión",
      severity: 'high',
      confidence: 'high',
      status: 'inReview',
      owner: 'Site Owner',
    ...
    {
      id: 'GOV-09-F03',
      title: "Aplicar etiquetas de sensibilidad a sitios, grupos, Teams o documentos - integración pendiente",
      severity: 'medium',
      confidence: 'low',
      status: 'exception',
