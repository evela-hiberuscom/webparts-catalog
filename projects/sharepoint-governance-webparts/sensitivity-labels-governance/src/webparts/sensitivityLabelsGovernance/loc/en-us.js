define([], function() {
  return {
    "PropertyPaneDescription": "Sensitivity Labels Governance settings",
    ...
    "WebPartTitle": "Sensitivity Labels Governance",
    "WebPartDescription": "Governance recommendations for sensitivity labels across sites, Teams and content.",
