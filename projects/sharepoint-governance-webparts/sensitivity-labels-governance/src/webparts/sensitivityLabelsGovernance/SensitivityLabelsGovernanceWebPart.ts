...
import * as strings from 'SensitivityLabelsGovernanceWebPartStrings';
import { SensitivityLabelsGovernanceDashboard } from './components/SensitivityLabelsGovernanceDashboard';
...
export interface ISensitivityLabelsGovernanceWebPartProps {
  title: string;
  subtitle: string;
  maxItems: number;
  showDetails: boolean;
...
export default class SensitivityLabelsGovernanceWebPart extends BaseClientSideWebPart<ISensitivityLabelsGovernanceWebPartProps> {
  ...
  public render(): void {
    ...
    const element = React.createElement(SensitivityLabelsGovernanceDashboard, {
