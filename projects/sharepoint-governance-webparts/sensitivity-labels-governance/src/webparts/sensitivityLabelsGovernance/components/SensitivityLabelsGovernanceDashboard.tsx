...
export interface ISensitivityLabelsGovernanceDashboardProps extends IGovernanceDashboardConfig {
...
export function SensitivityLabelsGovernanceDashboard(props: ISensitivityLabelsGovernanceDashboardProps): React.ReactElement {
