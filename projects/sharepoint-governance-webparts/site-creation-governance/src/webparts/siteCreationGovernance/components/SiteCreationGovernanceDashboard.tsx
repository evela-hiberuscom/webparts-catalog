...
export interface ISiteCreationGovernanceDashboardProps extends IGovernanceDashboardConfig {
...
export function SiteCreationGovernanceDashboard(props: ISiteCreationGovernanceDashboardProps): React.ReactElement {
