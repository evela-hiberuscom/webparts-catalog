...
export const mockGovernanceDashboardData: IGovernanceDashboardData = {
  initiativeId: 'GOV-01',
  initiativeTitle: "Definir quién puede crear sitios de SharePoint",
  phase: "Fase 1",
  initiativeType: "Política + control + reporting",
  sourceLabel: 'Mock data aligned with Governance Pack GOV-01',
  ...
  findings: [
    {
      id: 'GOV-01-F01',
      title: "Definir quién puede crear sitios de SharePoint - evidencia parcial",
      severity: 'medium',
      confidence: 'medium',
      status: 'pending',
    ...
    {
      id: 'GOV-01-F02',
      title: "Definir quién puede crear sitios de SharePoint - campaña de revisión",
      severity: 'medium',
      confidence: 'high',
      status: 'inReview',
      owner: 'Site Owner',
    ...
    {
      id: 'GOV-01-F03',
      title: "Definir quién puede crear sitios de SharePoint - integración pendiente",
      severity: 'medium',
      confidence: 'low',
      status: 'exception',
