define([], function() {
  return {
    "PropertyPaneDescription": "Configuración de Definir quién puede crear sitios de SharePoint",
    ...
    "WebPartTitle": "Definir quién puede crear sitios de SharePoint",
    "WebPartDescription": "Panel de gobierno para GOV-01 con datos mock y contrato backend pendiente.",
