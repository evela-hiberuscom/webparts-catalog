...
import * as strings from 'SiteCreationGovernanceWebPartStrings';
import { SiteCreationGovernanceDashboard } from './components/SiteCreationGovernanceDashboard';
...
export interface ISiteCreationGovernanceWebPartProps {
  title: string;
  subtitle: string;
  maxItems: number;
  showDetails: boolean;
...
export default class SiteCreationGovernanceWebPart extends BaseClientSideWebPart<ISiteCreationGovernanceWebPartProps> {
  ...
  public render(): void {
    ...
    const element = React.createElement(SiteCreationGovernanceDashboard, {
