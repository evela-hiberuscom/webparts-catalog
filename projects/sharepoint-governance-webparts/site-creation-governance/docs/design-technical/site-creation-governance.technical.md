# site-creation-governance — Technical design

## Components

- `SiteCreationGovernanceWebPart.ts`: SPFx entry point, property pane and ErrorBoundary wiring.
- `SiteCreationGovernanceDashboard.tsx`: visual composition.
...
**Crítica adversarial:** Riesgo de prometer bloqueo total desde la herramienta cuando el control real vive en configuración de tenant, Teams/M365 Groups y políticas Microsoft. La herramienta debe gobernar, auditar y recomendar; el enforcement debe validarse contra configuración oficial.
