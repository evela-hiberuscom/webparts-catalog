# site-creation-governance — Functional specification

## Description

GOV-01 — Definir quién puede crear sitios de SharePoint
...
- Site, owner or content inventory relevant to GOV-01.
...
- Se muestra quién puede crear sitios según configuración corroborada.
...
- Read-only backend endpoint for GOV-01.
