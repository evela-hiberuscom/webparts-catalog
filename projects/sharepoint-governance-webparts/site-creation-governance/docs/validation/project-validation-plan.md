...
Proyecto: site-creation-governance
Ruta: `projects/sharepoint-governance-webparts/site-creation-governance`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `site-creation-governance` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| siteCreationGovernance | SiteCreationGovernanceWebPart | c20d1fe2-bc09-4f25-a588-4f31511ec340 |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-053 | SiteCreationGovernanceWebPart | Mock-backed auditado | Media |
