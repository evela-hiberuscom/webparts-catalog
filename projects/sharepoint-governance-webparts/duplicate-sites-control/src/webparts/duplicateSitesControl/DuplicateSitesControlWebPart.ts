...
import * as strings from 'DuplicateSitesControlWebPartStrings';
import { DuplicateSitesControlDashboard } from './components/DuplicateSitesControlDashboard';
...
export interface IDuplicateSitesControlWebPartProps {
  title: string;
  subtitle: string;
  maxItems: number;
  showDetails: boolean;
...
export default class DuplicateSitesControlWebPart extends BaseClientSideWebPart<IDuplicateSitesControlWebPartProps> {
  ...
  public render(): void {
    ...
    const element = React.createElement(DuplicateSitesControlDashboard, {
