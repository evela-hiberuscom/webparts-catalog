...
export interface IDuplicateSitesControlDashboardProps extends IGovernanceDashboardConfig {
...
export function DuplicateSitesControlDashboard(props: IDuplicateSitesControlDashboardProps): React.ReactElement {
