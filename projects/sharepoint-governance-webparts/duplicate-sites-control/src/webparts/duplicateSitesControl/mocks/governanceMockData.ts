...
export const mockGovernanceDashboardData: IGovernanceDashboardData = {
  initiativeId: 'GOV-02',
  initiativeTitle: "Controlar la creación desordenada de sitios para evitar duplicados",
  phase: "Fase 2",
  initiativeType: "Motor de duplicados + workflow",
  sourceLabel: 'Mock data aligned with Governance Pack GOV-02',
  ...
  findings: [
    {
      id: 'GOV-02-F01',
      title: "Controlar la creación desordenada de sitios para evitar duplicados - evidencia parcial",
      severity: 'medium',
      confidence: 'medium',
      status: 'pending',
    ...
    {
      id: 'GOV-02-F02',
      title: "Controlar la creación desordenada de sitios para evitar duplicados - campaña de revisión",
      severity: 'medium',
      confidence: 'high',
      status: 'inReview',
      owner: 'Site Owner',
    ...
    {
      id: 'GOV-02-F03',
      title: "Controlar la creación desordenada de sitios para evitar duplicados - integración pendiente",
      severity: 'medium',
      confidence: 'low',
      status: 'exception',
