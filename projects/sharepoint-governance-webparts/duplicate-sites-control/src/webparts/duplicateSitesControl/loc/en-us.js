define([], function() {
  return {
    "PropertyPaneDescription": "Duplicate Sites Control settings",
    ...
    "WebPartTitle": "Duplicate Sites Control",
    "WebPartDescription": "Detection and review of duplicate or uncontrolled SharePoint sites.",
