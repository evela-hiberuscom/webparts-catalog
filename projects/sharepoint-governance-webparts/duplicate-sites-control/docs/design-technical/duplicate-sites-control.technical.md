# duplicate-sites-control — Technical design

## Components

- `DuplicateSitesControlWebPart.ts`: SPFx entry point, property pane and ErrorBoundary wiring.
- `DuplicateSitesControlDashboard.tsx`: visual composition.
...
**Crítica adversarial:** Los nombres similares no prueban duplicidad funcional. Hay riesgo de recomendar consolidaciones peligrosas entre áreas con datos sensibles. Debe ser asistente de revisión, no motor automático de merge.
