...
Proyecto: duplicate-sites-control
Ruta: `projects/sharepoint-governance-webparts/duplicate-sites-control`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `duplicate-sites-control` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| duplicateSitesControl | DuplicateSitesControlWebPart | a6a4e5df-8baa-4204-bd95-84d52bc9a550 |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-054 | DuplicateSitesControlWebPart | Mock-backed auditado | Media |
