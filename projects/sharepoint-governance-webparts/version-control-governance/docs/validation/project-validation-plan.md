...
Proyecto: version-control-governance
Ruta: `projects/sharepoint-governance-webparts/version-control-governance`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `version-control-governance` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| versionControlGovernance | VersionControlGovernanceWebPart | 7e0ed581-507c-4e48-9e0c-c87bc90731ef |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-066 | VersionControlGovernanceWebPart | Mock-backed auditado | Media |
