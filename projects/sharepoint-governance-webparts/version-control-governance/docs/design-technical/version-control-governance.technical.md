# version-control-governance — Technical design

## Components

- `VersionControlGovernanceWebPart.ts`: SPFx entry point, property pane and ErrorBoundary wiring.
- `VersionControlGovernanceDashboard.tsx`: visual composition.
...
**Crítica adversarial:** La limpieza masiva puede ser irreversible y puede violar retención. Debe diseñarse como módulo de alto riesgo con piloto, exclusiones y rollback limitado.
