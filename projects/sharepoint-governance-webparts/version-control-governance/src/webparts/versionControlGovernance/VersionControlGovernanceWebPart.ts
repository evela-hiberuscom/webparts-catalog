...
import * as strings from 'VersionControlGovernanceWebPartStrings';
import { VersionControlGovernanceDashboard } from './components/VersionControlGovernanceDashboard';
...
export interface IVersionControlGovernanceWebPartProps {
  title: string;
  subtitle: string;
  maxItems: number;
  showDetails: boolean;
...
export default class VersionControlGovernanceWebPart extends BaseClientSideWebPart<IVersionControlGovernanceWebPartProps> {
  ...
  public render(): void {
    ...
    const element = React.createElement(VersionControlGovernanceDashboard, {
