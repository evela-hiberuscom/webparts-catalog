...
export interface IVersionControlGovernanceDashboardProps extends IGovernanceDashboardConfig {
...
export function VersionControlGovernanceDashboard(props: IVersionControlGovernanceDashboardProps): React.ReactElement {
