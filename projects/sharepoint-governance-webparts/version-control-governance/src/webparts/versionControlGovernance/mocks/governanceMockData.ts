...
export const mockGovernanceDashboardData: IGovernanceDashboardData = {
  initiativeId: 'GOV-14',
  initiativeTitle: "Controlar versiones de documentos para evitar crecimiento excesivo",
  phase: "Fase 4",
  initiativeType: "Versioning governance + safe cleanup",
  sourceLabel: 'Mock data aligned with Governance Pack GOV-14',
  ...
  findings: [
    {
      id: 'GOV-14-F01',
      title: "Controlar versiones de documentos para evitar crecimiento excesivo - evidencia parcial",
      severity: 'critical',
      confidence: 'medium',
      status: 'pending',
    ...
    {
      id: 'GOV-14-F02',
      title: "Controlar versiones de documentos para evitar crecimiento excesivo - campaña de revisión",
      severity: 'high',
      confidence: 'high',
      status: 'inReview',
      owner: 'Site Owner',
    ...
    {
      id: 'GOV-14-F03',
      title: "Controlar versiones de documentos para evitar crecimiento excesivo - integración pendiente",
      severity: 'medium',
      confidence: 'low',
      status: 'exception',
