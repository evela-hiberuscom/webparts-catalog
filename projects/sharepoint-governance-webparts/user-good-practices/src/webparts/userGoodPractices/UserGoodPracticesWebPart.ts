...
import * as strings from 'UserGoodPracticesWebPartStrings';
import { UserGoodPracticesDashboard } from './components/UserGoodPracticesDashboard';
...
export interface IUserGoodPracticesWebPartProps {
  title: string;
  subtitle: string;
  maxItems: number;
  showDetails: boolean;
...
export default class UserGoodPracticesWebPart extends BaseClientSideWebPart<IUserGoodPracticesWebPartProps> {
  ...
  public render(): void {
    ...
    const element = React.createElement(UserGoodPracticesDashboard, {
