...
export interface IUserGoodPracticesDashboardProps extends IGovernanceDashboardConfig {
...
export function UserGoodPracticesDashboard(props: IUserGoodPracticesDashboardProps): React.ReactElement {
