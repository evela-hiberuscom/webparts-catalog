# user-good-practices — Technical design

## Components

- `UserGoodPracticesWebPart.ts`: SPFx entry point, property pane and ErrorBoundary wiring.
- `UserGoodPracticesDashboard.tsx`: visual composition.
...
**Crítica adversarial:** Documentación larga no se lee. Debe ser accionable, breve y vinculada a tareas concretas.
