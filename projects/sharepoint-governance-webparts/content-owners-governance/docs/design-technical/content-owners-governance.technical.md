# content-owners-governance — Technical design

## Components

- `ContentOwnersGovernanceWebPart.ts`: SPFx entry point, property pane and ErrorBoundary wiring.
- `ContentOwnersGovernanceDashboard.tsx`: visual composition.
...
**Crítica adversarial:** No confundir owner técnico con responsable de contenido. Debe validarse con negocio y no inferirse solo de permisos.
