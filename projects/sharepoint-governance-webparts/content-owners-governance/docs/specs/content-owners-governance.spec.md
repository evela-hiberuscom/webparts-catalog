# content-owners-governance — Functional specification

## Description

GOV-17 — Establecer responsables de contenido por área o departamento
...
- Site, owner or content inventory relevant to GOV-17.
...
- Cada sitio crítico tiene responsable funcional y backup.
...
- Read-only backend endpoint for GOV-17.
