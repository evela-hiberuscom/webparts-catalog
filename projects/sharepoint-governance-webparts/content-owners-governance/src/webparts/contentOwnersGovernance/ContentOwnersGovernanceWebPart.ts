...
import * as strings from 'ContentOwnersGovernanceWebPartStrings';
import { ContentOwnersGovernanceDashboard } from './components/ContentOwnersGovernanceDashboard';
...
export interface IContentOwnersGovernanceWebPartProps {
  title: string;
  subtitle: string;
  maxItems: number;
  showDetails: boolean;
...
export default class ContentOwnersGovernanceWebPart extends BaseClientSideWebPart<IContentOwnersGovernanceWebPartProps> {
  ...
  public render(): void {
    ...
    const element = React.createElement(ContentOwnersGovernanceDashboard, {
