...
export const mockGovernanceDashboardData: IGovernanceDashboardData = {
  initiativeId: 'GOV-17',
  initiativeTitle: "Establecer responsables de contenido por área o departamento",
  phase: "Fase 2",
  initiativeType: "RACI + ownership metadata",
  sourceLabel: 'Mock data aligned with Governance Pack GOV-17',
  ...
  findings: [
    {
      id: 'GOV-17-F01',
      title: "Establecer responsables de contenido por área o departamento - evidencia parcial",
      severity: 'low',
      confidence: 'medium',
      status: 'pending',
    ...
    {
      id: 'GOV-17-F02',
      title: "Establecer responsables de contenido por área o departamento - campaña de revisión",
      severity: 'medium',
      confidence: 'high',
      status: 'inReview',
      owner: 'Site Owner',
    ...
    {
      id: 'GOV-17-F03',
      title: "Establecer responsables de contenido por área o departamento - integración pendiente",
      severity: 'medium',
      confidence: 'low',
      status: 'exception',
