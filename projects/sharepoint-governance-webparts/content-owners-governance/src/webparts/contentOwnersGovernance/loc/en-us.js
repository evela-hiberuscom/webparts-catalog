define([], function() {
  return {
    "PropertyPaneDescription": "Content Owners Governance settings",
    ...
    "WebPartTitle": "Content Owners Governance",
    "WebPartDescription": "Ownership model for content by area or department.",
