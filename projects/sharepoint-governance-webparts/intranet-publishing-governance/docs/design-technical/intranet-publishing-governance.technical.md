# intranet-publishing-governance — Technical design

## Components

- `IntranetPublishingGovernanceWebPart.ts`: SPFx entry point, property pane and ErrorBoundary wiring.
- `IntranetPublishingGovernanceDashboard.tsx`: visual composition.
...
- https://support.microsoft.com/en-us/office/approval-flow-for-modern-pages-a8b2e689-d4a1-4639-8028-333c0ece30d9
...
**Crítica adversarial:** No todos los sitios necesitan aprobación formal; aplicar approval a todo puede bloquear agilidad. Diferenciar intranet corporativa de espacios colaborativos.
