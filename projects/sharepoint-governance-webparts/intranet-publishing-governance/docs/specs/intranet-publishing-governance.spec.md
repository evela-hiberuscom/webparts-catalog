# intranet-publishing-governance — Functional specification

## Description

GOV-16 — Definir políticas de publicación de páginas de intranet
...
- Site, owner or content inventory relevant to GOV-16.
...
- Cada página crítica tiene owner editorial.
...
- Read-only backend endpoint for GOV-16.
