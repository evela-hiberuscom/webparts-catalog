...
Proyecto: intranet-publishing-governance
Ruta: `projects/sharepoint-governance-webparts/intranet-publishing-governance`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `intranet-publishing-governance` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| intranetPublishingGovernance | IntranetPublishingGovernanceWebPart | b3bfaed3-4532-4c09-8aee-0826fff6e42c |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-068 | IntranetPublishingGovernanceWebPart | Mock-backed auditado | Media |
