define([], function() {
  return {
    "PropertyPaneDescription": "Configuración de Definir políticas de publicación de páginas de intranet",
    ...
    "WebPartTitle": "Definir políticas de publicación de páginas de intranet",
    "WebPartDescription": "Panel de gobierno para GOV-16 con datos mock y contrato backend pendiente.",
