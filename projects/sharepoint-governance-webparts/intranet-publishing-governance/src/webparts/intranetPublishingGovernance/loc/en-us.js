define([], function() {
  return {
    "PropertyPaneDescription": "Intranet Publishing Governance settings",
    ...
    "WebPartTitle": "Intranet Publishing Governance",
    "WebPartDescription": "Governance of intranet page publishing policies.",
