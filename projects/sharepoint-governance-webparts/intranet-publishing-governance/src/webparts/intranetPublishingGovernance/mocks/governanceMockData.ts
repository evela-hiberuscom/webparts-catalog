...
export const mockGovernanceDashboardData: IGovernanceDashboardData = {
  initiativeId: 'GOV-16',
  initiativeTitle: "Definir políticas de publicación de páginas de intranet",
  phase: "Fase 3",
  initiativeType: "Content publishing governance",
  sourceLabel: 'Mock data aligned with Governance Pack GOV-16',
  ...
  findings: [
    {
      id: 'GOV-16-F01',
      title: "Definir políticas de publicación de páginas de intranet - evidencia parcial",
      severity: 'medium',
      confidence: 'medium',
      status: 'pending',
    ...
    {
      id: 'GOV-16-F02',
      title: "Definir políticas de publicación de páginas de intranet - campaña de revisión",
      severity: 'medium',
      confidence: 'high',
      status: 'inReview',
      owner: 'Site Owner',
    ...
    {
      id: 'GOV-16-F03',
      title: "Definir políticas de publicación de páginas de intranet - integración pendiente",
      severity: 'medium',
      confidence: 'low',
      status: 'exception',
