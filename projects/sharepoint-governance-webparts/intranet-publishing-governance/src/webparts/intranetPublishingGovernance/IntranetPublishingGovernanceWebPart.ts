...
import * as strings from 'IntranetPublishingGovernanceWebPartStrings';
import { IntranetPublishingGovernanceDashboard } from './components/IntranetPublishingGovernanceDashboard';
...
export interface IIntranetPublishingGovernanceWebPartProps {
  title: string;
  subtitle: string;
  maxItems: number;
  showDetails: boolean;
...
export default class IntranetPublishingGovernanceWebPart extends BaseClientSideWebPart<IIntranetPublishingGovernanceWebPartProps> {
  ...
  public render(): void {
    ...
    const element = React.createElement(IntranetPublishingGovernanceDashboard, {
