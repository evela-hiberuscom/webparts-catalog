...
export interface IIntranetPublishingGovernanceDashboardProps extends IGovernanceDashboardConfig {
...
export function IntranetPublishingGovernanceDashboard(props: IIntranetPublishingGovernanceDashboardProps): React.ReactElement {
