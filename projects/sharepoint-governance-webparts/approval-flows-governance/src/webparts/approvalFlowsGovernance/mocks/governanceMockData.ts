...
export const mockGovernanceDashboardData: IGovernanceDashboardData = {
  initiativeId: 'GOV-19',
  initiativeTitle: "Definir flujos de aprobación si aplica",
  phase: "Fase 3",
  initiativeType: "Approval workflow design",
  sourceLabel: 'Mock data aligned with Governance Pack GOV-19',
  ...
  findings: [
    {
      id: 'GOV-19-F01',
      title: "Definir flujos de aprobación si aplica - evidencia parcial",
      severity: 'medium',
      confidence: 'medium',
      status: 'pending',
    ...
    {
      id: 'GOV-19-F02',
      title: "Definir flujos de aprobación si aplica - campaña de revisión",
      severity: 'medium',
      confidence: 'high',
      status: 'inReview',
      owner: 'Site Owner',
    ...
    {
      id: 'GOV-19-F03',
      title: "Definir flujos de aprobación si aplica - integración pendiente",
      severity: 'medium',
      confidence: 'low',
      status: 'exception',
