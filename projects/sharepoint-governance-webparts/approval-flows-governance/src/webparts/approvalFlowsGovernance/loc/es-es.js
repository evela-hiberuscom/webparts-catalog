define([], function() {
  return {
    "PropertyPaneDescription": "Configuración de Definir flujos de aprobación si aplica",
    ...
    "WebPartTitle": "Definir flujos de aprobación si aplica",
    "WebPartDescription": "Panel de gobierno para GOV-19 con datos mock y contrato backend pendiente.",
