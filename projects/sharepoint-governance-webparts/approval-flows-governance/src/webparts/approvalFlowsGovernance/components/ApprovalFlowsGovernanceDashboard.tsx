...
export interface IApprovalFlowsGovernanceDashboardProps extends IGovernanceDashboardConfig {
...
export function ApprovalFlowsGovernanceDashboard(props: IApprovalFlowsGovernanceDashboardProps): React.ReactElement {
