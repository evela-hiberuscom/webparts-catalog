...
import * as strings from 'ApprovalFlowsGovernanceWebPartStrings';
import { ApprovalFlowsGovernanceDashboard } from './components/ApprovalFlowsGovernanceDashboard';
...
export interface IApprovalFlowsGovernanceWebPartProps {
  title: string;
  subtitle: string;
  maxItems: number;
  showDetails: boolean;
...
export default class ApprovalFlowsGovernanceWebPart extends BaseClientSideWebPart<IApprovalFlowsGovernanceWebPartProps> {
  ...
  public render(): void {
    ...
    const element = React.createElement(ApprovalFlowsGovernanceDashboard, {
