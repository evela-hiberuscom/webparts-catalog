# approval-flows-governance — Functional specification

## Description

GOV-19 — Definir flujos de aprobación si aplica
...
- Site, owner or content inventory relevant to GOV-19.
...
- Cada acción sensible exige aprobación.
...
- Read-only backend endpoint for GOV-19.
