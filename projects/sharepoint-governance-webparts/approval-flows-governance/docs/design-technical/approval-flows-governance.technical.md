# approval-flows-governance — Technical design

## Components

- `ApprovalFlowsGovernanceWebPart.ts`: SPFx entry point, property pane and ErrorBoundary wiring.
- `ApprovalFlowsGovernanceDashboard.tsx`: visual composition.
...
**Crítica adversarial:** Demasiadas aprobaciones bloquean adopción. Debe haber matriz de riesgo: baja criticidad informativa, alta criticidad aprobada.
