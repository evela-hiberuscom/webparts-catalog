define([], function() {
  return {
    "PropertyPaneDescription": "Inactive Sites Validation settings",
    ...
    "WebPartTitle": "Inactive Sites Validation",
    "WebPartDescription": "Validation campaigns for inactive sites and their owners.",
