...
export interface IInactiveSitesValidationDashboardProps extends IGovernanceDashboardConfig {
...
export function InactiveSitesValidationDashboard(props: IInactiveSitesValidationDashboardProps): React.ReactElement {
