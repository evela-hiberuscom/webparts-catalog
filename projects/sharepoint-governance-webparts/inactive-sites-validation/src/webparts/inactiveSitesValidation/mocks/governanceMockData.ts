...
export const mockGovernanceDashboardData: IGovernanceDashboardData = {
  initiativeId: 'GOV-05',
  initiativeTitle: "Detectar sitios inactivos y pedir validación a sus propietarios",
  phase: "Fase 2",
  initiativeType: "Detección + revisión con owners",
  sourceLabel: 'Mock data aligned with Governance Pack GOV-05',
  ...
  findings: [
    {
      id: 'GOV-05-F01',
      title: "Detectar sitios inactivos y pedir validación a sus propietarios - evidencia parcial",
      severity: 'medium',
      confidence: 'medium',
      status: 'pending',
    ...
    {
      id: 'GOV-05-F02',
      title: "Detectar sitios inactivos y pedir validación a sus propietarios - campaña de revisión",
      severity: 'medium',
      confidence: 'high',
      status: 'inReview',
      owner: 'Site Owner',
    ...
    {
      id: 'GOV-05-F03',
      title: "Detectar sitios inactivos y pedir validación a sus propietarios - integración pendiente",
      severity: 'medium',
      confidence: 'low',
      status: 'exception',
