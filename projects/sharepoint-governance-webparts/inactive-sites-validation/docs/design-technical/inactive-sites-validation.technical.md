# inactive-sites-validation — Technical design

## Components

- `InactiveSitesValidationWebPart.ts`: SPFx entry point, property pane and ErrorBoundary wiring.
- `InactiveSitesValidationDashboard.tsx`: visual composition.
...
**Crítica adversarial:** Las campañas masivas pueden generar fatiga y respuestas falsas. Debe priorizar por riesgo/almacenamiento y limitar volumen por oleada.
