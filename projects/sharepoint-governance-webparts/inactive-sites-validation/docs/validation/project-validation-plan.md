...
Proyecto: inactive-sites-validation
Ruta: `projects/sharepoint-governance-webparts/inactive-sites-validation`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `inactive-sites-validation` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| inactiveSitesValidation | InactiveSitesValidationWebPart | a34903a8-ed34-4f07-a004-6034bde349b4 |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-057 | InactiveSitesValidationWebPart | Mock-backed auditado | Media |
