...
Proyecto: copilot-readiness
Ruta: `projects/sharepoint-governance-webparts/copilot-readiness`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `copilot-readiness` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| copilotReadiness | CopilotReadinessWebPart | a45e35e4-9e20-4f8d-a4d3-a3205f943f27 |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-076 | CopilotReadinessWebPart | Mock-backed auditado | Media |
