# copilot-readiness — Technical design

## Components

- `CopilotReadinessWebPart.ts`: SPFx entry point, property pane and ErrorBoundary wiring.
- `CopilotReadinessDashboard.tsx`: visual composition.
...
**Crítica adversarial:** Copilot no cambia permisos base; el problema es la visibilidad de permisos existentes. Evitar mensajes alarmistas y centrarlo en limpieza de acceso.
