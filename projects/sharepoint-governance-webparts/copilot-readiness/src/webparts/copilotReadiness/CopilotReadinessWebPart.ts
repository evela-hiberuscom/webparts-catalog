...
import * as strings from 'CopilotReadinessWebPartStrings';
import { CopilotReadinessDashboard } from './components/CopilotReadinessDashboard';
...
export interface ICopilotReadinessWebPartProps {
  title: string;
  subtitle: string;
  maxItems: number;
  showDetails: boolean;
...
export default class CopilotReadinessWebPart extends BaseClientSideWebPart<ICopilotReadinessWebPartProps> {
  ...
  public render(): void {
    ...
    const element = React.createElement(CopilotReadinessDashboard, {
