...
export const mockGovernanceDashboardData: IGovernanceDashboardData = {
  initiativeId: 'GOV-24',
  initiativeTitle: "Preparar SharePoint para Microsoft 365 Copilot evitando sobreexposición de documentos",
  phase: "Fase 3",
  initiativeType: "Copilot readiness",
  sourceLabel: 'Mock data aligned with Governance Pack GOV-24',
  ...
  findings: [
    {
      id: 'GOV-24-F01',
      title: "Preparar SharePoint para Microsoft 365 Copilot evitando sobreexposición de documentos - evidencia parcial",
      severity: 'high',
      confidence: 'medium',
      status: 'pending',
    ...
    {
      id: 'GOV-24-F02',
      title: "Preparar SharePoint para Microsoft 365 Copilot evitando sobreexposición de documentos - campaña de revisión",
      severity: 'high',
      confidence: 'high',
      status: 'inReview',
      owner: 'Site Owner',
    ...
    {
      id: 'GOV-24-F03',
      title: "Preparar SharePoint para Microsoft 365 Copilot evitando sobreexposición de documentos - integración pendiente",
      severity: 'medium',
      confidence: 'low',
      status: 'exception',
