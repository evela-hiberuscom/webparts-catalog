...
export interface ICopilotReadinessDashboardProps extends IGovernanceDashboardConfig {
...
export function CopilotReadinessDashboard(props: ICopilotReadinessDashboardProps): React.ReactElement {
