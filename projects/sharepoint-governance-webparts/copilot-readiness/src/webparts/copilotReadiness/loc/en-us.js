define([], function() {
  return {
    "PropertyPaneDescription": "Copilot Readiness settings",
    ...
    "WebPartTitle": "Copilot Readiness",
    "WebPartDescription": "Readiness review for Microsoft 365 Copilot and oversharing risks.",
