...
export interface ISupportModelGovernanceDashboardProps extends IGovernanceDashboardConfig {
...
export function SupportModelGovernanceDashboard(props: ISupportModelGovernanceDashboardProps): React.ReactElement {
