...
import * as strings from 'SupportModelGovernanceWebPartStrings';
import { SupportModelGovernanceDashboard } from './components/SupportModelGovernanceDashboard';
...
export interface ISupportModelGovernanceWebPartProps {
  title: string;
  subtitle: string;
  maxItems: number;
  showDetails: boolean;
...
export default class SupportModelGovernanceWebPart extends BaseClientSideWebPart<ISupportModelGovernanceWebPartProps> {
  ...
  public render(): void {
    ...
    const element = React.createElement(SupportModelGovernanceDashboard, {
