define([], function() {
  return {
    "PropertyPaneDescription": "Configuración de Definir un modelo de soporte: quién resuelve incidencias, altas, bajas, permisos y dudas",
    ...
    "WebPartTitle": "Definir un modelo de soporte: quién resuelve incidencias, altas, bajas, permisos y dudas",
    "WebPartDescription": "Panel de gobierno para GOV-22 con datos mock y contrato backend pendiente.",
