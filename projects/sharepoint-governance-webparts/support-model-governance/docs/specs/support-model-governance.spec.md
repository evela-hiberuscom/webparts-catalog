# support-model-governance — Functional specification

## Description

GOV-22 — Definir un modelo de soporte: quién resuelve incidencias, altas, bajas, permisos y dudas
...
- Site, owner or content inventory relevant to GOV-22.
...
- Cada tipo de incidencia tiene owner y SLA.
...
- Read-only backend endpoint for GOV-22.
