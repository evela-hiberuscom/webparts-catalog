# support-model-governance — Technical design

## Components

- `SupportModelGovernanceWebPart.ts`: SPFx entry point, property pane and ErrorBoundary wiring.
- `SupportModelGovernanceDashboard.tsx`: visual composition.
...
**Crítica adversarial:** Sin sponsorship organizativo, el modelo de soporte queda como documentación muerta. Debe ser acordado con operación real.
