...
Proyecto: support-model-governance
Ruta: `projects/sharepoint-governance-webparts/support-model-governance`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `support-model-governance` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| supportModelGovernance | SupportModelGovernanceWebPart | 545e2a1e-c497-4343-b201-dbed84925410 |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-074 | SupportModelGovernanceWebPart | Mock-backed auditado | Media |
