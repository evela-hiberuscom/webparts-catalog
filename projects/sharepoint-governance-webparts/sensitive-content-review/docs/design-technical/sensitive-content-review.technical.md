# sensitive-content-review — Technical design

## Components

- `SensitiveContentReviewWebPart.ts`: SPFx entry point, property pane and ErrorBoundary wiring.
- `SensitiveContentReviewDashboard.tsx`: visual composition.
...
**Crítica adversarial:** Escanear contenido sensible puede requerir licencias y permisos muy delicados. La herramienta debe minimizar acceso a contenido y preferir señales oficiales de Purview.
