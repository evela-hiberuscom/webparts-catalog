...
Proyecto: sensitive-content-review
Ruta: `projects/sharepoint-governance-webparts/sensitive-content-review`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `sensitive-content-review` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| sensitiveContentReview | SensitiveContentReviewWebPart | f0d8e283-80c5-4c0c-905e-9d1e4090ca3e |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-077 | SensitiveContentReviewWebPart | Mock-backed auditado | Media |
