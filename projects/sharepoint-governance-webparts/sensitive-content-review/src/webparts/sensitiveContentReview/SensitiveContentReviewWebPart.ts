...
import * as strings from 'SensitiveContentReviewWebPartStrings';
import { SensitiveContentReviewDashboard } from './components/SensitiveContentReviewDashboard';
...
export interface ISensitiveContentReviewWebPartProps {
  title: string;
  subtitle: string;
  maxItems: number;
  showDetails: boolean;
...
export default class SensitiveContentReviewWebPart extends BaseClientSideWebPart<ISensitiveContentReviewWebPartProps> {
  ...
  public render(): void {
    ...
    const element = React.createElement(SensitiveContentReviewDashboard, {
