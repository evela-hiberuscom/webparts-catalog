...
export interface ISensitiveContentReviewDashboardProps extends IGovernanceDashboardConfig {
...
export function SensitiveContentReviewDashboard(props: ISensitiveContentReviewDashboardProps): React.ReactElement {
