...
export const mockGovernanceDashboardData: IGovernanceDashboardData = {
  initiativeId: 'GOV-25',
  initiativeTitle: "Revisar contenido sensible antes de habilitar escenarios con Copilot",
  phase: "Fase 5",
  initiativeType: "Sensitive content review",
  sourceLabel: 'Mock data aligned with Governance Pack GOV-25',
  ...
  findings: [
    {
      id: 'GOV-25-F01',
      title: "Revisar contenido sensible antes de habilitar escenarios con Copilot - evidencia parcial",
      severity: 'critical',
      confidence: 'medium',
      status: 'pending',
    ...
    {
      id: 'GOV-25-F02',
      title: "Revisar contenido sensible antes de habilitar escenarios con Copilot - campaña de revisión",
      severity: 'high',
      confidence: 'high',
      status: 'inReview',
      owner: 'Site Owner',
    ...
    {
      id: 'GOV-25-F03',
      title: "Revisar contenido sensible antes de habilitar escenarios con Copilot - integración pendiente",
      severity: 'medium',
      confidence: 'low',
      status: 'exception',
