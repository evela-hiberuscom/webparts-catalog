define([], function() {
  return {
    "PropertyPaneDescription": "Sensitive Content Review settings",
    ...
    "WebPartTitle": "Sensitive Content Review",
    "WebPartDescription": "Review of sensitive content before enabling Copilot scenarios.",
