...
export const mockGovernanceDashboardData: IGovernanceDashboardData = {
  initiativeId: 'GOV-27',
  initiativeTitle: "Mantener un inventario de sitios, propietarios, propósito, criticidad y estado",
  phase: "Fase 1",
  initiativeType: "Core inventory / single source of truth",
  sourceLabel: 'Mock data aligned with Governance Pack GOV-27',
  ...
  findings: [
    {
      id: 'GOV-27-F01',
      title: "Mantener un inventario de sitios, propietarios, propósito, criticidad y estado - evidencia parcial",
      severity: 'low',
      confidence: 'medium',
      status: 'pending',
    ...
    {
      id: 'GOV-27-F02',
      title: "Mantener un inventario de sitios, propietarios, propósito, criticidad y estado - campaña de revisión",
      severity: 'medium',
      confidence: 'high',
      status: 'inReview',
      owner: 'Site Owner',
    ...
    {
      id: 'GOV-27-F03',
      title: "Mantener un inventario de sitios, propietarios, propósito, criticidad y estado - integración pendiente",
      severity: 'medium',
      confidence: 'low',
      status: 'exception',
