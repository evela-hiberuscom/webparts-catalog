...
import * as strings from 'TenantSiteInventoryWebPartStrings';
import { TenantSiteInventoryDashboard } from './components/TenantSiteInventoryDashboard';
...
export interface ITenantSiteInventoryWebPartProps {
  title: string;
  subtitle: string;
  maxItems: number;
  showDetails: boolean;
...
export default class TenantSiteInventoryWebPart extends BaseClientSideWebPart<ITenantSiteInventoryWebPartProps> {
  ...
  public render(): void {
    ...
    const element = React.createElement(TenantSiteInventoryDashboard, {
