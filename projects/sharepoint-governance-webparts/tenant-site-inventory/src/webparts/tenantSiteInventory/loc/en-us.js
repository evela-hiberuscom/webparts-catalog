define([], function() {
  return {
    "PropertyPaneDescription": "Tenant Site Inventory settings",
    ...
    "WebPartTitle": "Tenant Site Inventory",
    "WebPartDescription": "Master inventory of sites, owners, purpose, criticality and status.",
