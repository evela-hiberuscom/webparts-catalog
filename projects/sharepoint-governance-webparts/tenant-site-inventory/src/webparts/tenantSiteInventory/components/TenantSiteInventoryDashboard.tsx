...
export interface ITenantSiteInventoryDashboardProps extends IGovernanceDashboardConfig {
...
export function TenantSiteInventoryDashboard(props: ITenantSiteInventoryDashboardProps): React.ReactElement {
