...
Proyecto: tenant-site-inventory
Ruta: `projects/sharepoint-governance-webparts/tenant-site-inventory`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `tenant-site-inventory` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| tenantSiteInventory | TenantSiteInventoryWebPart | 5c597ef1-8ac2-4d9c-920e-c8cb4c99a637 |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-079 | TenantSiteInventoryWebPart | Mock-backed auditado | Media |
