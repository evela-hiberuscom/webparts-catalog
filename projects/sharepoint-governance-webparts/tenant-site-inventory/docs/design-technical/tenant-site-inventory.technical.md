# tenant-site-inventory — Technical design

## Components

- `TenantSiteInventoryWebPart.ts`: SPFx entry point, property pane and ErrorBoundary wiring.
- `TenantSiteInventoryDashboard.tsx`: visual composition.
...
**Crítica adversarial:** El inventario será incompleto si no se resuelven multi-geo, channel sites, grupos eliminados o permisos insuficientes. Debe marcar cobertura y confianza por campo.
