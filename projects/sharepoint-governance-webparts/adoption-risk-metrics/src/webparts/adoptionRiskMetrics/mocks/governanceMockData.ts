...
export const mockGovernanceDashboardData: IGovernanceDashboardData = {
  initiativeId: 'GOV-26',
  initiativeTitle: "Medir uso, adopción, sitios activos, documentos compartidos y riesgos",
  phase: "Fase 2",
  initiativeType: "Metrics & KPI framework",
  sourceLabel: 'Mock data aligned with Governance Pack GOV-26',
  ...
  findings: [
    {
      id: 'GOV-26-F01',
      title: "Medir uso, adopción, sitios activos, documentos compartidos y riesgos - evidencia parcial",
      severity: 'medium',
      confidence: 'medium',
      status: 'pending',
    ...
    {
      id: 'GOV-26-F02',
      title: "Medir uso, adopción, sitios activos, documentos compartidos y riesgos - campaña de revisión",
      severity: 'medium',
      confidence: 'high',
      status: 'inReview',
      owner: 'Site Owner',
    ...
    {
      id: 'GOV-26-F03',
      title: "Medir uso, adopción, sitios activos, documentos compartidos y riesgos - integración pendiente",
      severity: 'medium',
      confidence: 'low',
      status: 'exception',
