define([], function() {
  return {
    "PropertyPaneDescription": "Adoption Risk Metrics settings",
    ...
    "WebPartTitle": "Adoption Risk Metrics",
    "WebPartDescription": "Usage, adoption, active-site and risk metrics.",
