...
import * as strings from 'AdoptionRiskMetricsWebPartStrings';
import { AdoptionRiskMetricsDashboard } from './components/AdoptionRiskMetricsDashboard';
...
export interface IAdoptionRiskMetricsWebPartProps {
  title: string;
  subtitle: string;
  maxItems: number;
  showDetails: boolean;
...
export default class AdoptionRiskMetricsWebPart extends BaseClientSideWebPart<IAdoptionRiskMetricsWebPartProps> {
  ...
  public render(): void {
    ...
    const element = React.createElement(AdoptionRiskMetricsDashboard, {
