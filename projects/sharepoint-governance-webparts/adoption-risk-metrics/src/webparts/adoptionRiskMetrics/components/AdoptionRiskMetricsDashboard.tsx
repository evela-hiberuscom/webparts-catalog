...
export interface IAdoptionRiskMetricsDashboardProps extends IGovernanceDashboardConfig {
...
export function AdoptionRiskMetricsDashboard(props: IAdoptionRiskMetricsDashboardProps): React.ReactElement {
