# adoption-risk-metrics — Technical design

## Components

- `AdoptionRiskMetricsWebPart.ts`: SPFx entry point, property pane and ErrorBoundary wiring.
- `AdoptionRiskMetricsDashboard.tsx`: visual composition.
...
**Crítica adversarial:** Métricas vanidosas como “número de sitios” no bastan. Priorizar métricas accionables y comparables mes a mes.
