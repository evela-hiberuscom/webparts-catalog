...
Proyecto: adoption-risk-metrics
Ruta: `projects/sharepoint-governance-webparts/adoption-risk-metrics`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `adoption-risk-metrics` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| adoptionRiskMetrics | AdoptionRiskMetricsWebPart | 5665b4ec-515f-41ef-ae0f-d865eae37bf9 |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-078 | AdoptionRiskMetricsWebPart | Mock-backed auditado | Media |
