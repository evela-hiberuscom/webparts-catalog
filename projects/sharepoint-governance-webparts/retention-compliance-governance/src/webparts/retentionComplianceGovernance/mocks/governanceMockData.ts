...
export const mockGovernanceDashboardData: IGovernanceDashboardData = {
  initiativeId: 'GOV-10',
  initiativeTitle: "Definir qué documentos deben conservarse por obligación legal o normativa",
  phase: "Fase 5",
  initiativeType: "Records/retention governance",
  sourceLabel: 'Mock data aligned with Governance Pack GOV-10',
  ...
  findings: [
    {
      id: 'GOV-10-F01',
      title: "Definir qué documentos deben conservarse por obligación legal o normativa - evidencia parcial",
      severity: 'critical',
      confidence: 'medium',
      status: 'pending',
    ...
    {
      id: 'GOV-10-F02',
      title: "Definir qué documentos deben conservarse por obligación legal o normativa - campaña de revisión",
      severity: 'high',
      confidence: 'high',
      status: 'inReview',
      owner: 'Site Owner',
    ...
    {
      id: 'GOV-10-F03',
      title: "Definir qué documentos deben conservarse por obligación legal o normativa - integración pendiente",
      severity: 'medium',
      confidence: 'low',
      status: 'exception',
