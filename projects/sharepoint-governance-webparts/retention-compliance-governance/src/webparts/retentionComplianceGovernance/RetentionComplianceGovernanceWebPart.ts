...
import * as strings from 'RetentionComplianceGovernanceWebPartStrings';
import { RetentionComplianceGovernanceDashboard } from './components/RetentionComplianceGovernanceDashboard';
...
export interface IRetentionComplianceGovernanceWebPartProps {
  title: string;
  subtitle: string;
  maxItems: number;
  showDetails: boolean;
...
export default class RetentionComplianceGovernanceWebPart extends BaseClientSideWebPart<IRetentionComplianceGovernanceWebPartProps> {
  ...
  public render(): void {
    ...
    const element = React.createElement(RetentionComplianceGovernanceDashboard, {
