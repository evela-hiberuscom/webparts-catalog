...
export interface IRetentionComplianceGovernanceDashboardProps extends IGovernanceDashboardConfig {
...
export function RetentionComplianceGovernanceDashboard(props: IRetentionComplianceGovernanceDashboardProps): React.ReactElement {
