# retention-compliance-governance — Technical design

## Components

- `RetentionComplianceGovernanceWebPart.ts`: SPFx entry point, property pane and ErrorBoundary wiring.
- `RetentionComplianceGovernanceDashboard.tsx`: visual composition.
...
**Crítica adversarial:** El equipo técnico no puede inventar obligaciones legales. Debe requerir validación de Legal/Compliance y tratar la app como herramienta de evidencia, no como autoridad jurídica.
