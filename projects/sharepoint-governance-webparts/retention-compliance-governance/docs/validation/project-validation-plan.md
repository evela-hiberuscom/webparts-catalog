...
Proyecto: retention-compliance-governance
Ruta: `projects/sharepoint-governance-webparts/retention-compliance-governance`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `retention-compliance-governance` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| retentionComplianceGovernance | RetentionComplianceGovernanceWebPart | 1077ec7f-f685-4365-86b7-000285c2889e |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-062 | RetentionComplianceGovernanceWebPart | Mock-backed auditado | Media |
