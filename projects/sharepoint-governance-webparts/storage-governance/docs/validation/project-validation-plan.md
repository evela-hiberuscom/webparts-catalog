...
Proyecto: storage-governance
Ruta: `projects/sharepoint-governance-webparts/storage-governance`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `storage-governance` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| storageGovernance | StorageGovernanceWebPart | b7a8cc00-e982-4ff7-a710-c3a56b61e770 |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-064 | StorageGovernanceWebPart | Mock-backed auditado | Media |
