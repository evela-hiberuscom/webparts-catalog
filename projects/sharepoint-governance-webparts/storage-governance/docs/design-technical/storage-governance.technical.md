# storage-governance — Technical design

## Components

- `StorageGovernanceWebPart.ts`: SPFx entry point, property pane and ErrorBoundary wiring.
- `StorageGovernanceDashboard.tsx`: visual composition.
...
**Crítica adversarial:** No prometer desglose perfecto del coste de versiones/papelera si la API no lo expone de forma directa. Empezar por site-level fiable y bajar a biblioteca donde sea viable.
