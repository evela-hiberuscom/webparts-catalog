...
export interface IStorageGovernanceDashboardProps extends IGovernanceDashboardConfig {
...
export function StorageGovernanceDashboard(props: IStorageGovernanceDashboardProps): React.ReactElement {
