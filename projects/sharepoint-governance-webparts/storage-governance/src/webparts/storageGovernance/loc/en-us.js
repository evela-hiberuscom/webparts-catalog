define([], function() {
  return {
    "PropertyPaneDescription": "Storage Governance settings",
    ...
    "WebPartTitle": "Storage Governance",
    "WebPartDescription": "Monitoring of storage consumption across sites and libraries.",
