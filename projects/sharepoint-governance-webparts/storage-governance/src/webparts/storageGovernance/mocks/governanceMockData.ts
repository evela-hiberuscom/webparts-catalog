...
export const mockGovernanceDashboardData: IGovernanceDashboardData = {
  initiativeId: 'GOV-12',
  initiativeTitle: "Monitorizar el almacenamiento usado por sitios y bibliotecas",
  phase: "Fase 1",
  initiativeType: "Storage analytics",
  sourceLabel: 'Mock data aligned with Governance Pack GOV-12',
  ...
  findings: [
    {
      id: 'GOV-12-F01',
      title: "Monitorizar el almacenamiento usado por sitios y bibliotecas - evidencia parcial",
      severity: 'low',
      confidence: 'medium',
      status: 'pending',
    ...
    {
      id: 'GOV-12-F02',
      title: "Monitorizar el almacenamiento usado por sitios y bibliotecas - campaña de revisión",
      severity: 'medium',
      confidence: 'high',
      status: 'inReview',
      owner: 'Site Owner',
    ...
    {
      id: 'GOV-12-F03',
      title: "Monitorizar el almacenamiento usado por sitios y bibliotecas - integración pendiente",
      severity: 'medium',
      confidence: 'low',
      status: 'exception',
