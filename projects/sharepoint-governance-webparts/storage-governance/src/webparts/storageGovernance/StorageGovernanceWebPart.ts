...
import * as strings from 'StorageGovernanceWebPartStrings';
...
export interface IStorageGovernanceWebPartProps {
  title: string;
  subtitle: string;
  maxItems: number;
  showDetails: boolean;
...
export default class StorageGovernanceWebPart extends BaseClientSideWebPart<IStorageGovernanceWebPartProps> {
  ...
  public render(): void {
    ...
    const element = React.createElement(StorageGovernanceDashboard, {
