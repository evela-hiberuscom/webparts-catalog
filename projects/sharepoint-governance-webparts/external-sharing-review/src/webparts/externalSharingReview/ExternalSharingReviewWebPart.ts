...
import * as strings from 'ExternalSharingReviewWebPartStrings';
import { ExternalSharingReviewDashboard } from './components/ExternalSharingReviewDashboard';
...
export interface IExternalSharingReviewWebPartProps {
  title: string;
  subtitle: string;
  maxItems: number;
  showDetails: boolean;
...
export default class ExternalSharingReviewWebPart extends BaseClientSideWebPart<IExternalSharingReviewWebPartProps> {
  ...
  public render(): void {
    ...
    const element = React.createElement(ExternalSharingReviewDashboard, {
