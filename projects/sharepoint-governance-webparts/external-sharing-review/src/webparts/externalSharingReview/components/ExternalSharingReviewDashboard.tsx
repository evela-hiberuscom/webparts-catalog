...
export interface IExternalSharingReviewDashboardProps extends IGovernanceDashboardConfig {
...
export function ExternalSharingReviewDashboard(props: IExternalSharingReviewDashboardProps): React.ReactElement {
