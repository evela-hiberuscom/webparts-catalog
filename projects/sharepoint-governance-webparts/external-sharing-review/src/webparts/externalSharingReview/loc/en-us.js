define([], function() {
  return {
    "PropertyPaneDescription": "External Sharing Review settings",
    ...
    "WebPartTitle": "External Sharing Review",
    "WebPartDescription": "Review of externally shared documents and exposure risks.",
