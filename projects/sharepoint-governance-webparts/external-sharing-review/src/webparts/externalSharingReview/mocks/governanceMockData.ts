...
export const mockGovernanceDashboardData: IGovernanceDashboardData = {
  initiativeId: 'GOV-08',
  initiativeTitle: "Revisar documentos compartidos externamente",
  phase: "Fase 3",
  initiativeType: "External sharing review",
  sourceLabel: 'Mock data aligned with Governance Pack GOV-08',
  ...
  findings: [
    {
      id: 'GOV-08-F01',
      title: "Revisar documentos compartidos externamente - evidencia parcial",
      severity: 'high',
      confidence: 'medium',
      status: 'pending',
    ...
    {
      id: 'GOV-08-F02',
      title: "Revisar documentos compartidos externamente - campaña de revisión",
      severity: 'high',
      confidence: 'high',
      status: 'inReview',
      owner: 'Site Owner',
    ...
    {
      id: 'GOV-08-F03',
      title: "Revisar documentos compartidos externamente - integración pendiente",
      severity: 'medium',
      confidence: 'low',
      status: 'exception',
