# external-sharing-review — Technical design

## Components

- `ExternalSharingReviewWebPart.ts`: SPFx entry point, property pane and ErrorBoundary wiring.
- `ExternalSharingReviewDashboard.tsx`: visual composition.
...
**Crítica adversarial:** No todas las APIs devuelven un inventario perfecto a escala tenant. El diseño debe admitir cobertura parcial, site-by-site y limitaciones conocidas.
