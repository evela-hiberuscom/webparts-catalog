...
Proyecto: external-sharing-review
Ruta: `projects/sharepoint-governance-webparts/external-sharing-review`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `external-sharing-review` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| externalSharingReview | ExternalSharingReviewWebPart | eb2796ef-4b48-49a0-ab78-024911f11b41 |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-060 | ExternalSharingReviewWebPart | Mock-backed auditado | Media |
