# site-archive-retention-governance — Technical design

## Components

- `SiteArchiveRetentionGovernanceWebPart.ts`: SPFx entry point, property pane and ErrorBoundary wiring.
- `SiteArchiveRetentionGovernanceDashboard.tsx`: visual composition.
...
**Crítica adversarial:** “Archivar” en SharePoint/Teams puede significar cosas distintas. Puede requerir SAM, Teams admin o diseño propio de read-only. Evitar venderlo como una acción universal.
