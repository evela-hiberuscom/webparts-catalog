# site-archive-retention-governance — Functional specification

## Description

GOV-06 — Definir cuándo archivar, conservar o eliminar sitios antiguos
...
- Site, owner or content inventory relevant to GOV-06.
...
- Cada recomendación tiene explicación y fuentes.
...
- Read-only backend endpoint for GOV-06.
