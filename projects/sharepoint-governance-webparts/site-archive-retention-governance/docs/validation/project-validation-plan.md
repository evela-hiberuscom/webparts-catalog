...
Proyecto: site-archive-retention-governance
Ruta: `projects/sharepoint-governance-webparts/site-archive-retention-governance`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `site-archive-retention-governance` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| siteArchiveRetentionGovernance | SiteArchiveRetentionGovernanceWebPart | 7e31a7d6-9819-4cb7-9d2d-399619e4c094 |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-058 | SiteArchiveRetentionGovernanceWebPart | Mock-backed auditado | Media |
