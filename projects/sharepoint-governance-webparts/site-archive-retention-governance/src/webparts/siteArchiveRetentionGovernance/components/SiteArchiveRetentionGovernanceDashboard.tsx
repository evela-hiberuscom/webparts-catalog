...
export interface ISiteArchiveRetentionGovernanceDashboardProps extends IGovernanceDashboardConfig {
...
export function SiteArchiveRetentionGovernanceDashboard(props: ISiteArchiveRetentionGovernanceDashboardProps): React.ReactElement {
