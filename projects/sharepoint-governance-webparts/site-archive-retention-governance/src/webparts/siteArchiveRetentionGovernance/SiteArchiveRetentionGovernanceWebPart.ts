...
import * as strings from 'SiteArchiveRetentionGovernanceWebPartStrings';
import { SiteArchiveRetentionGovernanceDashboard } from './components/SiteArchiveRetentionGovernanceDashboard';
...
export interface ISiteArchiveRetentionGovernanceWebPartProps {
  title: string;
  subtitle: string;
  maxItems: number;
  showDetails: boolean;
...
export default class SiteArchiveRetentionGovernanceWebPart extends BaseClientSideWebPart<ISiteArchiveRetentionGovernanceWebPartProps> {
  ...
  public render(): void {
    ...
    const element = React.createElement(SiteArchiveRetentionGovernanceDashboard, {
