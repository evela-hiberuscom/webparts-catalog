define([], function() {
  return {
    "PropertyPaneDescription": "Configuración de Definir cuándo archivar, conservar o eliminar sitios antiguos",
    ...
    "WebPartTitle": "Definir cuándo archivar, conservar o eliminar sitios antiguos",
    "WebPartDescription": "Panel de gobierno para GOV-06 con datos mock y contrato backend pendiente.",
