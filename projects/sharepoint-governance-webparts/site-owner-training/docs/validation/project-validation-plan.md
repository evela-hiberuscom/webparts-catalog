...
Proyecto: site-owner-training
Ruta: `projects/sharepoint-governance-webparts/site-owner-training`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `site-owner-training` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| siteOwnerTraining | SiteOwnerTrainingWebPart | a5fb1ca0-479b-481e-9a2c-23c432466299 |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-073 | SiteOwnerTrainingWebPart | Mock-backed auditado | Media |
