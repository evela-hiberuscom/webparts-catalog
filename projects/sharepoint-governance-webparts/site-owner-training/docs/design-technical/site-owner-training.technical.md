# site-owner-training — Technical design

## Components

- `SiteOwnerTrainingWebPart.ts`: SPFx entry point, property pane and ErrorBoundary wiring.
- `SiteOwnerTrainingDashboard.tsx`: visual composition.
...
**Crítica adversarial:** La formación no sustituye controles técnicos. Medirla como reducción de riesgo, no como garantía.
