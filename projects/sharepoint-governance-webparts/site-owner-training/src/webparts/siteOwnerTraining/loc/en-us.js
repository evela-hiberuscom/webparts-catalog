define([], function() {
  return {
    "PropertyPaneDescription": "Site Owner Training settings",
    ...
    "WebPartTitle": "Site Owner Training",
    "WebPartDescription": "Training and enablement for site owners and key users.",
