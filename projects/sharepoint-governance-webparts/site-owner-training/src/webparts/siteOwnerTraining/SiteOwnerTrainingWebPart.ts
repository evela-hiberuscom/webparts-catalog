...
import * as strings from 'SiteOwnerTrainingWebPartStrings';
import { SiteOwnerTrainingDashboard } from './components/SiteOwnerTrainingDashboard';
...
export interface ISiteOwnerTrainingWebPartProps {
  title: string;
  subtitle: string;
  maxItems: number;
  showDetails: boolean;
...
export default class SiteOwnerTrainingWebPart extends BaseClientSideWebPart<ISiteOwnerTrainingWebPartProps> {
  ...
  public render(): void {
    ...
    const element = React.createElement(SiteOwnerTrainingDashboard, {
