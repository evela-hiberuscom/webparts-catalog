...
export const mockGovernanceDashboardData: IGovernanceDashboardData = {
  initiativeId: 'GOV-21',
  initiativeTitle: "Formar a propietarios de sitios y usuarios clave",
  phase: "Fase 2",
  initiativeType: "Adoption + training",
  sourceLabel: 'Mock data aligned with Governance Pack GOV-21',
  ...
  findings: [
    {
      id: 'GOV-21-F01',
      title: "Formar a propietarios de sitios y usuarios clave - evidencia parcial",
      severity: 'low',
      confidence: 'medium',
      status: 'pending',
    ...
    {
      id: 'GOV-21-F02',
      title: "Formar a propietarios de sitios y usuarios clave - campaña de revisión",
      severity: 'medium',
      confidence: 'high',
      status: 'inReview',
      owner: 'Site Owner',
    ...
    {
      id: 'GOV-21-F03',
      title: "Formar a propietarios de sitios y usuarios clave - integración pendiente",
      severity: 'medium',
      confidence: 'low',
      status: 'exception',
