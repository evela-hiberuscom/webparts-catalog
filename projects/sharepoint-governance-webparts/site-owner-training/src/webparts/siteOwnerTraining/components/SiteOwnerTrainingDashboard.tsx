...
export interface ISiteOwnerTrainingDashboardProps extends IGovernanceDashboardConfig {
...
export function SiteOwnerTrainingDashboard(props: ISiteOwnerTrainingDashboardProps): React.ReactElement {
