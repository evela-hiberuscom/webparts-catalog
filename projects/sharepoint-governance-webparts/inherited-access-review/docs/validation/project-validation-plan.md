...
Proyecto: inherited-access-review
Ruta: `projects/sharepoint-governance-webparts/inherited-access-review`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `inherited-access-review` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| inheritedAccessReview | InheritedAccessReviewWebPart | f2254198-c015-48c2-b102-6ade56008726 |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-059 | InheritedAccessReviewWebPart | Mock-backed auditado | Media |
