# inherited-access-review — Technical design

## Components

- `InheritedAccessReviewWebPart.ts`: SPFx entry point, property pane and ErrorBoundary wiring.
- `InheritedAccessReviewDashboard.tsx`: visual composition.
...
**Crítica adversarial:** Escanear permisos de todos los ítems del tenant puede ser carísimo y sufrir throttling. Debe empezar por sitios críticos, bibliotecas grandes, external sharing y señales DAG.
