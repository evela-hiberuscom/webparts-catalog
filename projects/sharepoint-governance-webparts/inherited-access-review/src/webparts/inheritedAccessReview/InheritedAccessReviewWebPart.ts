...
import * as strings from 'InheritedAccessReviewWebPartStrings';
import { InheritedAccessReviewDashboard } from './components/InheritedAccessReviewDashboard';
...
export interface IInheritedAccessReviewWebPartProps {
  title: string;
  subtitle: string;
  maxItems: number;
  showDetails: boolean;
...
export default class InheritedAccessReviewWebPart extends BaseClientSideWebPart<IInheritedAccessReviewWebPartProps> {
  ...
  public render(): void {
    ...
    const element = React.createElement(InheritedAccessReviewDashboard, {
