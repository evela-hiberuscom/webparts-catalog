...
export interface IInheritedAccessReviewDashboardProps extends IGovernanceDashboardConfig {
...
export function InheritedAccessReviewDashboard(props: IInheritedAccessReviewDashboardProps): React.ReactElement {
