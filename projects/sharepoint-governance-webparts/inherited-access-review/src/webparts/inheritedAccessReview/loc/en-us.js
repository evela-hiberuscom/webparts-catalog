define([], function() {
  return {
    "PropertyPaneDescription": "Inherited Access Review settings",
    ...
    "WebPartTitle": "Inherited Access Review",
    "WebPartDescription": "Periodic review of inherited and direct permissions.",
