...
export const mockGovernanceDashboardData: IGovernanceDashboardData = {
  initiativeId: 'GOV-07',
  initiativeTitle: "Revisar periódicamente accesos heredados y accesos directos",
  phase: "Fase 3",
  initiativeType: "Permissions review",
  sourceLabel: 'Mock data aligned with Governance Pack GOV-07',
  ...
  findings: [
    {
      id: 'GOV-07-F01',
      title: "Revisar periódicamente accesos heredados y accesos directos - evidencia parcial",
      severity: 'high',
      confidence: 'medium',
      status: 'pending',
    ...
    {
      id: 'GOV-07-F02',
      title: "Revisar periódicamente accesos heredados y accesos directos - campaña de revisión",
      severity: 'high',
      confidence: 'high',
      status: 'inReview',
      owner: 'Site Owner',
    ...
    {
      id: 'GOV-07-F03',
      title: "Revisar periódicamente accesos heredados y accesos directos - integración pendiente",
      severity: 'medium',
      confidence: 'low',
      status: 'exception',
