...
export interface IStorageQuotaGovernanceDashboardProps extends IGovernanceDashboardConfig {
...
export function StorageQuotaGovernanceDashboard(props: IStorageQuotaGovernanceDashboardProps): React.ReactElement {
