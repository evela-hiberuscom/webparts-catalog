...
export const mockGovernanceDashboardData: IGovernanceDashboardData = {
  initiativeId: 'GOV-13',
  initiativeTitle: "Definir cuotas o controles de crecimiento de almacenamiento",
  phase: "Fase 3",
  initiativeType: "Storage policy",
  sourceLabel: 'Mock data aligned with Governance Pack GOV-13',
  ...
  findings: [
    {
      id: 'GOV-13-F01',
      title: "Definir cuotas o controles de crecimiento de almacenamiento - evidencia parcial",
      severity: 'high',
      confidence: 'medium',
      status: 'pending',
    ...
    {
      id: 'GOV-13-F02',
      title: "Definir cuotas o controles de crecimiento de almacenamiento - campaña de revisión",
      severity: 'high',
      confidence: 'high',
      status: 'inReview',
      owner: 'Site Owner',
    ...
    {
      id: 'GOV-13-F03',
      title: "Definir cuotas o controles de crecimiento de almacenamiento - integración pendiente",
      severity: 'medium',
      confidence: 'low',
      status: 'exception',
