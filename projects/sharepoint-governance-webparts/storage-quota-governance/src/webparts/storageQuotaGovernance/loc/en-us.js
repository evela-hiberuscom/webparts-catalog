define([], function() {
  return {
    "PropertyPaneDescription": "Storage Quota Governance settings",
    ...
    "WebPartTitle": "Storage Quota Governance",
    "WebPartDescription": "Quota and growth-control governance for SharePoint storage.",
