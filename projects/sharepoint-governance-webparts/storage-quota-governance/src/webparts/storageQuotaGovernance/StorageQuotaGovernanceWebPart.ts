...
import * as strings from 'StorageQuotaGovernanceWebPartStrings';
import { StorageQuotaGovernanceDashboard } from './components/StorageQuotaGovernanceDashboard';
...
export interface IStorageQuotaGovernanceWebPartProps {
  title: string;
  subtitle: string;
  maxItems: number;
  showDetails: boolean;
...
export default class StorageQuotaGovernanceWebPart extends BaseClientSideWebPart<IStorageQuotaGovernanceWebPartProps> {
  ...
  public render(): void {
    ...
    const element = React.createElement(StorageQuotaGovernanceDashboard, {
