...
Proyecto: storage-quota-governance
Ruta: `projects/sharepoint-governance-webparts/storage-quota-governance`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `storage-quota-governance` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| storageQuotaGovernance | StorageQuotaGovernanceWebPart | 4bcd539b-3d03-43e3-a367-ee868b368c07 |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-065 | StorageQuotaGovernanceWebPart | Mock-backed auditado | Media |
