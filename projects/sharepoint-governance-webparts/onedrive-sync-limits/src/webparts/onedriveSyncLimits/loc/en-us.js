define([], function() {
  return {
    "PropertyPaneDescription": "OneDrive Sync Limits settings",
    ...
    "WebPartTitle": "OneDrive Sync Limits",
    "WebPartDescription": "Visibility and recommendations for OneDrive sync limits and policies.",
