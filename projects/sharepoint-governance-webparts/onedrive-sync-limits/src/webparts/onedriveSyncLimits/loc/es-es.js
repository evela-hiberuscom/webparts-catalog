define([], function() {
  return {
    "PropertyPaneDescription": "Configuración de Definir límites de sincronización con OneDrive",
    ...
    "WebPartTitle": "Definir límites de sincronización con OneDrive",
    "WebPartDescription": "Panel de gobierno para GOV-15 con datos mock y contrato backend pendiente.",
