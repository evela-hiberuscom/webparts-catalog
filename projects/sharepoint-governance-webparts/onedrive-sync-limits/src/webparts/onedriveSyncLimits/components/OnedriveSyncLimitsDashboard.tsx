...
export interface IOnedriveSyncLimitsDashboardProps extends IGovernanceDashboardConfig {
...
export function OnedriveSyncLimitsDashboard(props: IOnedriveSyncLimitsDashboardProps): React.ReactElement {
