...
Proyecto: onedrive-sync-limits
Ruta: `projects/sharepoint-governance-webparts/onedrive-sync-limits`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `onedrive-sync-limits` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| onedriveSyncLimits | OnedriveSyncLimitsWebPart | c2c211b4-f8e9-4927-a122-289695afdbb4 |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-067 | OnedriveSyncLimitsWebPart | Mock-backed auditado | Media |
