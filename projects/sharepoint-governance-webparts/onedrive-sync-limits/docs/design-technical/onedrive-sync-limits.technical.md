# onedrive-sync-limits — Technical design

## Components

- `OnedriveSyncLimitsWebPart.ts`: SPFx entry point, property pane and ErrorBoundary wiring.
- `OnedriveSyncLimitsDashboard.tsx`: visual composition.
