...
export const mockGovernanceDashboardData: IGovernanceDashboardData = {
  initiativeId: 'GOV-03',
  initiativeTitle: "Revisar sitios sin propietario o con propietarios inactivos",
  phase: "Fase 1",
  initiativeType: "Detección + remediación asistida",
  sourceLabel: 'Mock data aligned with Governance Pack GOV-03',
  ...
  findings: [
    {
      id: 'GOV-03-F01',
      title: "Revisar sitios sin propietario o con propietarios inactivos - evidencia parcial",
      severity: 'medium',
      confidence: 'medium',
      status: 'pending',
    ...
    {
      id: 'GOV-03-F02',
      title: "Revisar sitios sin propietario o con propietarios inactivos - campaña de revisión",
      severity: 'medium',
      confidence: 'high',
      status: 'inReview',
      owner: 'Site Owner',
    ...
    {
      id: 'GOV-03-F03',
      title: "Revisar sitios sin propietario o con propietarios inactivos - integración pendiente",
      severity: 'medium',
      confidence: 'low',
      status: 'exception',
