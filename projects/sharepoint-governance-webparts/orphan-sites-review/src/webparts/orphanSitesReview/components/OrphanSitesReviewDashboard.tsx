...
export interface IOrphanSitesReviewDashboardProps extends IGovernanceDashboardConfig {
...
export function OrphanSitesReviewDashboard(props: IOrphanSitesReviewDashboardProps): React.ReactElement {
