define([], function() {
  return {
    "PropertyPaneDescription": "Orphan Sites Review settings",
    ...
    "WebPartTitle": "Orphan Sites Review",
    "WebPartDescription": "Review of sites without owners or with inactive owners.",
