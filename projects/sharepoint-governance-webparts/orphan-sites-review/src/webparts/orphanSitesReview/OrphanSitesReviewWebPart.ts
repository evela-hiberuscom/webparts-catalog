...
import * as strings from 'OrphanSitesReviewWebPartStrings';
import { OrphanSitesReviewDashboard } from './components/OrphanSitesReviewDashboard';
...
export interface IOrphanSitesReviewWebPartProps {
  title: string;
  subtitle: string;
  maxItems: number;
  showDetails: boolean;
...
export default class OrphanSitesReviewWebPart extends BaseClientSideWebPart<IOrphanSitesReviewWebPartProps> {
  ...
  public render(): void {
    ...
    const element = React.createElement(OrphanSitesReviewDashboard, {
