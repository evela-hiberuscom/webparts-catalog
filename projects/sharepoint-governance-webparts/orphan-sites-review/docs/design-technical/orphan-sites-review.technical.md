# orphan-sites-review — Technical design

## Components

- `OrphanSitesReviewWebPart.ts`: SPFx entry point, property pane and ErrorBoundary wiring.
- `OrphanSitesReviewDashboard.tsx`: visual composition.
...
**Crítica adversarial:** Determinar “inactivo” puede requerir señales de Entra/Graph con permisos adicionales. No asumir que no hay owner solo porque el owner no aparece en una API concreta; hay owners del grupo, site admins y owners de Teams con semánticas distintas.
