...
Proyecto: orphan-sites-review
Ruta: `projects/sharepoint-governance-webparts/orphan-sites-review`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `orphan-sites-review` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| orphanSitesReview | OrphanSitesReviewWebPart | 8abfaf42-5cb6-4cd7-a77c-6a41fb4fa449 |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-055 | OrphanSitesReviewWebPart | Mock-backed auditado | Media |
