# orphan-sites-review — Functional specification

## Description

GOV-03 — Revisar sitios sin propietario o con propietarios inactivos
...
- Site, owner or content inventory relevant to GOV-03.
...
- Se detectan sitios con menos de dos propietarios humanos activos.
...
- Read-only backend endpoint for GOV-03.
