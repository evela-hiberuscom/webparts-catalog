...
export interface ISiteLifecycleGovernanceDashboardProps extends IGovernanceDashboardConfig {
...
export function SiteLifecycleGovernanceDashboard(props: ISiteLifecycleGovernanceDashboardProps): React.ReactElement {
