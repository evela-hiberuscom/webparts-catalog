define([], function() {
  return {
    "PropertyPaneDescription": "Configuración de Crear políticas de ciclo de vida para sitios activos, inactivos, archivados o eliminables",
    ...
    "WebPartTitle": "Crear políticas de ciclo de vida para sitios activos, inactivos, archivados o eliminables",
    "WebPartDescription": "Panel de gobierno para GOV-04 con datos mock y contrato backend pendiente.",
