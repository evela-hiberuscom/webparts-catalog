...
export const mockGovernanceDashboardData: IGovernanceDashboardData = {
  initiativeId: 'GOV-04',
  initiativeTitle: "Crear políticas de ciclo de vida para sitios activos, inactivos, archivados o eliminables",
  phase: "Fase 3",
  initiativeType: "Política + lifecycle engine",
  sourceLabel: 'Mock data aligned with Governance Pack GOV-04',
  ...
  findings: [
    {
      id: 'GOV-04-F01',
      title: "Crear políticas de ciclo de vida para sitios activos, inactivos, archivados o eliminables - evidencia parcial",
      severity: 'high',
      confidence: 'medium',
      status: 'pending',
    ...
    {
      id: 'GOV-04-F02',
      title: "Crear políticas de ciclo de vida para sitios activos, inactivos, archivados o eliminables - campaña de revisión",
      severity: 'high',
      confidence: 'high',
      status: 'inReview',
      owner: 'Site Owner',
    ...
    {
      id: 'GOV-04-F03',
      title: "Crear políticas de ciclo de vida para sitios activos, inactivos, archivados o eliminables - integración pendiente",
      severity: 'medium',
      confidence: 'low',
      status: 'exception',
