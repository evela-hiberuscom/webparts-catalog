...
import * as strings from 'SiteLifecycleGovernanceWebPartStrings';
import { SiteLifecycleGovernanceDashboard } from './components/SiteLifecycleGovernanceDashboard';
...
export interface ISiteLifecycleGovernanceWebPartProps {
  title: string;
  subtitle: string;
  maxItems: number;
  showDetails: boolean;
...
export default class SiteLifecycleGovernanceWebPart extends BaseClientSideWebPart<ISiteLifecycleGovernanceWebPartProps> {
  ...
  public render(): void {
    ...
    const element = React.createElement(SiteLifecycleGovernanceDashboard, {
