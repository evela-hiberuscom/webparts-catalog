...
Proyecto: site-lifecycle-governance
Ruta: `projects/sharepoint-governance-webparts/site-lifecycle-governance`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `site-lifecycle-governance` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| siteLifecycleGovernance | SiteLifecycleGovernanceWebPart | 5aae1ae8-a77e-4061-b1fe-f9701b2db0a7 |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-056 | SiteLifecycleGovernanceWebPart | Mock-backed auditado | Media |
