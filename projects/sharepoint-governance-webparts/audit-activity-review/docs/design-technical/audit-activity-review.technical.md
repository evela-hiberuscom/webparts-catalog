# audit-activity-review — Technical design

## Components

- `AuditActivityReviewWebPart.ts`: SPFx entry point, property pane and ErrorBoundary wiring.
- `AuditActivityReviewDashboard.tsx`: visual composition.
...
**Crítica adversarial:** Audit logs pueden tener latencia, límites y retención dependiente de licencia. No diseñar como SIEM completo salvo integración con plataforma corporativa.
