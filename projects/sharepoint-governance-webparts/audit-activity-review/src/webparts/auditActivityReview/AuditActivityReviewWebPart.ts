...
import * as strings from 'AuditActivityReviewWebPartStrings';
import { AuditActivityReviewDashboard } from './components/AuditActivityReviewDashboard';
...
export interface IAuditActivityReviewWebPartProps {
  title: string;
  subtitle: string;
  maxItems: number;
  showDetails: boolean;
...
export default class AuditActivityReviewWebPart extends BaseClientSideWebPart<IAuditActivityReviewWebPartProps> {
  ...
  public render(): void {
    ...
    const element = React.createElement(AuditActivityReviewDashboard, {
