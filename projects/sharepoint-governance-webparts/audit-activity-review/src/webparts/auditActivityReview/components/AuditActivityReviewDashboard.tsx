...
export interface IAuditActivityReviewDashboardProps extends IGovernanceDashboardConfig {
...
export function AuditActivityReviewDashboard(props: IAuditActivityReviewDashboardProps): React.ReactElement {
