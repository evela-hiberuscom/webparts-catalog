define([], function() {
  return {
    "PropertyPaneDescription": "Configuración de Revisar auditorías de actividad: acceso, descarga, borrado, compartición, cambios de permisos",
    ...
    "WebPartTitle": "Revisar auditorías de actividad: acceso, descarga, borrado, compartición, cambios de permisos",
    "WebPartDescription": "Panel de gobierno para GOV-11 con datos mock y contrato backend pendiente.",
