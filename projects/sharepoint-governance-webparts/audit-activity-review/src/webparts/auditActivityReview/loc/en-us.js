define([], function() {
  return {
    "PropertyPaneDescription": "Audit Activity Review settings",
    ...
    "WebPartTitle": "Audit Activity Review",
    "WebPartDescription": "Review of access, download, deletion, sharing and permission-change audit activity.",
