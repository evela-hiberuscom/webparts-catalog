...
export const mockGovernanceDashboardData: IGovernanceDashboardData = {
  initiativeId: 'GOV-11',
  initiativeTitle: "Revisar auditorías de actividad: acceso, descarga, borrado, compartición, cambios de permisos",
  phase: "Fase 4",
  initiativeType: "Audit analytics",
  sourceLabel: 'Mock data aligned with Governance Pack GOV-11',
  ...
  findings: [
    {
      id: 'GOV-11-F01',
      title: "Revisar auditorías de actividad: acceso, descarga, borrado, compartición, cambios de permisos - evidencia parcial",
      severity: 'high',
      confidence: 'medium',
      status: 'pending',
    ...
    {
      id: 'GOV-11-F02',
      title: "Revisar auditorías de actividad: acceso, descarga, borrado, compartición, cambios de permisos - campaña de revisión",
      severity: 'high',
      confidence: 'high',
      status: 'inReview',
      owner: 'Site Owner',
    ...
    {
      id: 'GOV-11-F03',
      title: "Revisar auditorías de actividad: acceso, descarga, borrado, compartición, cambios de permisos - integración pendiente",
      severity: 'medium',
      confidence: 'low',
      status: 'exception',
