...
Proyecto: a-z-corporativo
Ruta: `projects/a-z-corporativo`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `a-z-corporativo` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| corporateAz | CorporateAzWebPart | 935e679e-25e9-4173-9003-b3f2a4c0ec6c |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-028 | CorporateAzWebPart | Experimental | Media |
