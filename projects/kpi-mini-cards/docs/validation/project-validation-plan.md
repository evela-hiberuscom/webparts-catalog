...
Proyecto: kpi-mini-cards
Ruta: `projects/kpi-mini-cards`
Fecha: 2026-05-28

## Objetivo del proyecto

Validar el proyecto SPFx independiente `kpi-mini-cards` contra el catálogo, los arneses del repositorio y las reglas SPFx/React/Fluent UI aplicables.

## Webpart o webparts incluidos

| Webpart folder | Manifest alias | Manifest id |
| --- | --- | --- |
| kpiMiniCards | KpiMiniCardsWebPart | 1582b415-c38e-401c-8213-bca86796c1c3 |

## Relación con el catálogo

| Entrada | Clase | Estado | Reutilización |
| --- | --- | --- | --- |
| WP-019 | KpiMiniCardsWebPart | Maduro | Media |
