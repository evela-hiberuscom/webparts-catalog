define([], function() {
  return {
    "PropertyPaneDescription": "Configura el origen de acciones, el catálogo y el comportamiento visual.",
    "BasicGroupName": "Configuración principal",
    ...
    "JsonUrlOptionLabel": "JSON same-origin",
    "StaticConfigOptionLabel": "Configuración estática",
    "ListTitleOrUrlFieldLabel": "Lista o URL same-origin",
    "JsonUrlFieldLabel": "URL JSON same-origin",
    "StaticActionsJsonFieldLabel": "JSON de acciones estáticas",
    "DefaultCategoryFieldLabel": "Categoría por defecto",
    "MaxItemsFieldLabel": "Máximo de acciones",
